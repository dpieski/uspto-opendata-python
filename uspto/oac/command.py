...
from uspto.peds.client import UsptoOfficeActionCitationsClient
...
def run():
    ...
    try:
        from uspto.oac.tasks import UsptoOfficeActionCitationsDownloader
        client.downloader = UsptoOfficeActionCitationsDownloader()
